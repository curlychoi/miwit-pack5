...
.<?php echo $style_name?>latest-swipe .swipe-page div.thumb {
    padding:10px 0;
    height:120px;
    overflow:hidden;
    border:0;
...
.<?php echo $style_name?>latest-swipe .swipe-page div.thumb img {
    -webkit-border-radius:.5em; -moz-border-radius:.5em; border-radius:.5em;
}
.<?php echo $style_name?>latest-swipe .swipe-page div.thumb div.img {
    display:inline;
    border:0;
...
.<?php echo $style_name?>latest-swipe .swipe-page div.thumb div.cap {
    display:block;
    width:85px;
    height:30px;
    margin:0 auto 0 auto;
